...
- **Proposer:** [Kylin Labs](https://gitub.com/Kylin-Network)
...
**Beni Issembert**
   ...
   \-   GTM for BEAM.mw + Chief Marketing Officer
...
### Team Code Repos
- Kylin Network: https://github.com/Kylin-NetworkTeam 
### Linkedin Profiles
...
| Kylin Network Oracle Node Repo | Oracle node built on top of Substrate 2.0, connected to Polkadot network as a parachain, having the simplest schema of oracle market. |
...
| Kylin Network Datasource Sample Repo | Sample datasource working with off-chain worker, interactive with Kylin Network oracle node. |
